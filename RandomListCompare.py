    ...
    while True:
        ...
        while(True):
            ...
            while(list2[k] != list1[k]):
                ...
                i += 1
                print("Second list is currently "," ".join(map(str,list2)), end = '\r')
            k += 1
            if(list2 == list1):
                print("Second list is currently "," ".join(map(str,list2)), end = '\r')
                print("")
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print("Note that if the list is linger than your screen is wide, the printing will start to fill the console.")
            while True:
